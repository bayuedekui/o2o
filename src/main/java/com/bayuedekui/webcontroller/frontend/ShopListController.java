...
public class ShopListController {
     ...
     * @return
     */
    @RequestMapping(value = "/listshopinfo", method = RequestMethod.GET)
    @ResponseBody
    ...
    private Map<String,Object> listShops(HttpServletRequest request){
        ...
        if(pageIndex>-1 && pageSize >-1){
            ...
            //获取组合后的查询条件
            Shop shopCondition=compackShopCondition4Search(long parentId,long shopCategoryId,long areaId,String shopName);    
        }
     ...
     * @return
     */
    private Shop compackShopCondition4Search(long parentId,long shopCategory,long areaId,String shopName){
